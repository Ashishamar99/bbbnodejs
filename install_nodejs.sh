...
${bold}${NODENAME} is no longer actively supported!${normal}
   ...
   * ${green}https://deb.nodesource.com/setup_10.x â€” Node.js 10 LTS \"Dubnium\"${normal}
   * ${green}https://deb.nodesource.com/setup_12.x â€” Node.js 12 LTS \"Erbium\"${normal} (recommended)
   * ${green}https://deb.nodesource.com/setup_14.x â€” Node.js 14 LTS \"Fermium\"${normal}
...
This script, located at ${bold}https://deb.nodesource.com/setup${normal}, used to
   ...
   * ${green}https://deb.nodesource.com/setup_10.x â€” Node.js 10 LTS \"Dubnium\"${normal} (recommended)
